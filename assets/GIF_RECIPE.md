...
## Settings
- **Resolution**: 480p (Landscape: 1056x480)
- **Framerate**: 30 fps
- **Filters**: 
  - `transpose=2`: 90-degree counter-clockwise rotation (Portrait to Landscape)
  - `scale=-2:480`: Resize to 480px height with Lanczos scaling
...
ffmpeg -y -ss 00:00:01 -t 60 -i assets/bubble_globe.mp4 \
  -vf "transpose=2,fps=30,scale=-2:480:flags=lanczos,split[s0][s1];[s0]palettegen=max_colors=128[p];[s1][p]paletteuse=dither=bayer:bayer_scale=3" \
